...
- Fourteen path-by-path, design, valuation and specification labs for participation products, accumulators, decumulators, reverse convertibles, step-down autocalls, baskets, conditional coupons, memory, lock-in features, early-exit value, structured-product Greeks, dynamic hedging, volatility skew, cross-currency and quanto payoffs, issuer credit, liquidity and term-sheet analysis
