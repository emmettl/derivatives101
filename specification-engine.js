(function (root) {
  ...
  const api = { terms, profiles, scenarios, choiceDefinitions, referenceLevel, comparisonPass, compile, evaluate, normalizedRows, acceptanceTests };
  root.SpecificationEngine = api;
