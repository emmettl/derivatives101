...
import { TRADING_DAYS as DAYS, normalRandom as normal, seededRandom as seeded } from "../shared/simulation";
...
export { DAYS, SPOT, STRIKE, seeded, hasBonus, participation, outperformance, redemption, crossover, barrierState, pairedPaths, pairOutcomes, callPrice, budget, simulate };
